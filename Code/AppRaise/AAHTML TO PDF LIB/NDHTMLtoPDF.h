...
#define kPaperSizeA4 CGSizeMake(595.2,841.8) // Original
#define kPaperSizeA4_Appraise CGSizeMake(595,842)
#define kPaperSizeA4_Test CGSizeMake(595,421)
...
@property (nonatomic, assign) id <NDHTMLtoPDFDelegate> delegate;
